...
mod tests {
    ...
    fn harmonic_experience_is_stored_with_its_consequence() {
        ...
        reinforce_memory_point(
            ...
            1,
            &spectrum,
            crate::decision::ActionConsequence { energy_delta: 1.0, stress_delta: 0.0, developmental_delta: 0.0 },
        );
        ...
        assert_eq!(
            ...
            Some(crate::decision::ActionConsequence { energy_delta: 1.0, stress_delta: 0.0, developmental_delta: 0.0 })
        );
    }
    ...
    fn perception_memory_is_level_one_until_an_outcome_occurs() {
        ...
        reinforce_memory_point(
            ...
            1,
            &spectrum,
            crate::decision::ActionConsequence { energy_delta: -1.0, stress_delta: 1.0, developmental_delta: 0.0 },
        );

        assert_eq!(
            organism.memory[0].consequence,
            Some(crate::decision::ActionConsequence { energy_delta: -1.0, stress_delta: 1.0, developmental_delta: 0.0 })
        );
