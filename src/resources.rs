...
BaseResource{name:"Phosphorus".into(),properties:ResourceProperties{mass:1.75,potential_energy:1.5,reactivity:0.75,cohesion:0.6},shape:Shape{form:Polygon{vertices:vec![(-0.408248,-0.408248),(0.408248,-0.408248),(0.408248,0.0),(0.0,0.0),(0.0,0.408248),(-0.408248,0.408248)]}}},
BaseResource{name:"Water".into(),properties:ResourceProperties{mass:1.0,potential_energy:0.0,reactivity:0.0,cohesion:0.5},shape:Shape{form:Fluid{nominal_area:NOMINAL_UNIT_AREA}}}]}
