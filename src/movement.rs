...
impl Simulation {
    pub(crate) fn update_movement(organism: &mut Organism, environment: &Environment) -> bool {
        ...
        Self::try_move_cell(organism, environment, x * step, y * step)
    }
    ...
    pub(crate) fn try_move_cell(
        ...
        if movement_collides_with_environment(organism, environment, dx, dy) { return false; }
...
fn movement_collides_with_environment(organism: &Organism, environment: &Environment, dx: f64, dy: f64) -> bool {
