...
impl MaterialStorage{
 ...
 /// Remove one intact material matching the requested physical identity.
 /// No chemistry, bonding, splitting, or recombination occurs here.
 pub(crate)fn take_matching(&mut self,target:&Material)->Option<Material>{let index=self.materials.iter().position(|material|material==target&&!material.is_empty())?;Some(self.materials.swap_remove(index))}
...
#[cfg(test)]mod tests{
 use super::*;use crate::resources::{InternalBond,Material};
