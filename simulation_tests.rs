...
mod integration_tests {
    ...
    fn structural_units_count_toward_total_material_conservation() {
        ...
        sim.organisms[0].structure.add_unit(StructuralUnit::new("Carbon", Placement { x: 500.0, y: 500.0, rotation_radians: 0.0 }));
    ...
    fn organism_can_break_a_structural_bond_and_records_outcome() {
        ...
        let b = sim.organisms[0].structure.add_unit(StructuralUnit::new("Methane", Placement { x: 501.0, y: 500.0, rotation_radians: 0.0 }));
        sim.organisms[0].structure.add_bond(Bond { unit_a: a, point_a: 0, unit_b: b, point_b: 0, strength: 0.8, bond_energy: 12.5 });
