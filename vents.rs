...
/// Transfer material from each vent's local reservoir region into its home field cell.
/// Vents are indiscriminate with respect to bonded/unbonded state: the draw is
/// proportional to local availability and preserves the state of each transferred unit.
